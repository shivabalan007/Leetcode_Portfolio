<h2><a href="https://leetcode.com/problems/count-common-words-with-one-occurrence/?envType=problem-list-v2&envId=string">2085. Count Common Words With One Occurrence</a></h2><h3>Easy</h3><hr><p>Given two string arrays <code>words1</code> and <code>words2</code>, return <em>the number of strings that appear <strong>exactly once</strong> in <b>each</b>&nbsp;of the two arrays.</em></p>
